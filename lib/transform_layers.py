"""
Factor Transformation Pipeline (DEPRECATED)
============================================

DEPRECATION NOTICE:
    This module is deprecated. Use `utils.transforms` instead, which provides:
    - compute_rolling_percentile()
    - compute_rolling_zscore()
    - compute_credit_gap()
    - compute_ushape_transform()
    - apply_transforms()
...
warnings.warn(
    "lib.transform_layers is deprecated. Use utils.transforms instead.",
    DeprecationWarning,
    stacklevel=2
)
